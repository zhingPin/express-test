...
export const createThreadByAssistantId = catchAsync(async (req, res, next) => {
...
export const createThread = catchAsync(async (req, res, next) => {
    ...
    const { title = "", notes = "", metadata = {}, initialMessage = "", tool_resources = [], object = "thread", // default fallback
     } = req.body;
    // Save to DB
